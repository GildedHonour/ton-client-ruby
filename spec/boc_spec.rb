...
describe TonSdk::Boc do
  context "methods of boc" do
    it "#parse_message" do
      ...
      @res = TonSdk::Boc.parse_message(@c_ctx.context, pr1)
    ...
    it "#parse_account" do
      ...
      @res = TonSdk::Boc.parse_account(@c_ctx.context, pr1) { |a| @res = a }
      expect(@res.success?).to eq true
    ...
    it "#parse_transaction" do
      ...
      @res = TonSdk::Boc.parse_transaction(@c_ctx.context, pr1)
      expect(@res.success?).to eq true
    ...
    it "#parse_block" do
      ...
      @res = TonSdk::Boc.parse_block(@c_ctx.context, pr1)
    ...
    it "#parse_shardstate" do
      ...
      @res = TonSdk::Boc.parse_shardstate(@c_ctx.context, pr1)
      expect(@res.success?).to eq true
    ...
    it "#get_blockchain_config" do
      ...
      @res = TonSdk::Boc.get_blockchain_config(@c_ctx.context, pr1)
      expect(@res.success?).to eq true
    ...
    it "#get_boc_hash" do
      ...
      @res = TonSdk::Boc.get_boc_hash(@c_ctx.context, pr1)
      expect(@res.success?).to eq true
